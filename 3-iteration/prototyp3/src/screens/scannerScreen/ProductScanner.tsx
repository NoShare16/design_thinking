...
import { addRecentSearch } from "@/common/searchStorage";
  ...
  return (
    <div className="productScannerScreen">
      ...
      <div className="contentBody">
        <video
          className="viewFinder productScannerCard"
          ref={videoRef}
          autoPlay
          muted
          playsInline
        />
        {!isInitialLoad && product && (
          <ResultCard product={product!} warnings={warning} />
        )}
        {isInitialLoad && (
          <div className="productScannerCard textCard">
            Halte ein Produkt in die mitte der Kamera um es zu scannen
          </div>
        )}
        {loading && (
        ...
        {scannerError && (
          <div className="productScannerCard textCard">
            {"Es ist ein Fehler beim Scannen des Produktes aufgetreten: " +
              scannerError.toString()}
          </div>
        )}
        {queryError && (
          <div className="productScannerCard textCard">
...
function PersonResult({ warning }: { warning: FoodWarningReturn }) {
  const causeHint = warning.matching_allergens;
